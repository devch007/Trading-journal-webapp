      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
            ...
            <Route path="trades" element={<PlaceholderPage title="Trades" subtitle="View your trading history" />} />
            <Route path="journal" element={<PlaceholderPage title="Journal" subtitle="Review your trading journal" />} />
